...
export default function OutletMasterBarangPage() {
  ...
  /*
   * =========================================================
   * AMBIL HARGA YANG DITAMPILKAN
   *
   * PRIORITAS:
   *
   * 1. Harga terakhir pembelian outlet
   * 2. Harga master outlet
   * 3. Harga purchase central
   * 4. 0
   * =========================================================
   */
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Harga ini hanya menjadi
                    fallback. Harga terakhir
                    pembelian akan otomatis
