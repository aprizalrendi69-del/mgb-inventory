...
// BARU:
// Delivery Request dari outlet yang menunggu
// diproses oleh Gudang/Pusat.
...
//
// Delivery Request dari outlet yang masih PENDING
// harus muncul sebagai tanda di:
//
// Barang Keluar pusat
// /barang-keluar
//
...
// Alur:
//
// Outlet membuat Delivery Request
//        ↓
// Status PENDING
//        ↓
// Sidebar Barang Keluar pusat muncul badge
//        ↓
// Gudang membuka Barang Keluar
//        ↓
// Request diproses
//
// =====================================================
...
if (role === "ADMIN" || role === "GUDANG") {
  deliveryRequest = await safeCount(() =>
