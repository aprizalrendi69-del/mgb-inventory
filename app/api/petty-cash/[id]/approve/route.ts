...
Saldo hanya mengambil:

pettyCash.accountId
        ↓
pettyCashAccount.currentBalance

Tidak menghitung ulang saldo dari seluruh transaksi.
*/
...
export async function POST(
  ...
  try {
    ...
    */
    ...
    /*
    ========================================================
    5. READ BODY SECARA AMAN
    ========================================================

    Body BOLEH kosong.

    Ini penting karena frontend bisa saja hanya:

    POST /api/petty-cash/28/approve
    ...
    */
    ...
    try {
      ...
      console.error(
        "PETTY CASH APPROVAL BODY PARSE ERROR:",
        error
      );
      ...
      await prisma.$transaction(
        async (tx) => {
          ...
          */
          ...
          Jadi transaksi OUT tetap bisa diproses
          meskipun saldo tidak mencukupi.
